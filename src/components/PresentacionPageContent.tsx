                ...
                <>
                  ...
                  <ToggleSection title="Read more">
                    <p className="mb-3">
                      ...
                      {" "}was launched from this platform, which remains current to this day. Shortly afterwards, in July 2020, the EPA also improved the graphical interface of{" "}
                      ...
                      , integrating the latest version of the Toolkit.
                    </p>
                    <p className="mb-3">
